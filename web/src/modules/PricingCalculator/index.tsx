...
function computeTiers({ cost, shipping, basetaoFeePercent }: PricingInput): PricingTier[] {
...
interface PricingProfile extends PricingInput {
  productName: string
  tiers: PricingTier[]
}

export default function PricingCalculator() {
  const saved = useSupabaseTable<SavedItem<PricingProfile>>('saved_items', {
    match: { kind: 'pricing_profile' },
  })
