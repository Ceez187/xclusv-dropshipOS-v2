...
const EMPTY_FORM = { name: '', email: '', total_orders: '', ltv: '', is_repeat: false, notes: '' }

function buildAnalysisMessages(customer, orders) {
...
export default function CustomerIntelligence() {
  const customers = useSupabaseTable('customers')
  ...
  const [analyzing, setAnalyzing] = useState(null) // customer id
  const [analysis, setAnalysis] = useState({}) // { [customerId]: text }
  ...
  async function handleAnalyze(customer) {
