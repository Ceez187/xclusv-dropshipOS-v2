  ...
  return (
    <div className="space-y-6">
      {sourcingHistory.rows.length > 0 && (
        <Card>
          <h3 className="mb-2 text-sm font-semibold text-slate-700">Pull from Smart Sourcing history</h3>
      ...
      {saved.rows.length > 0 && (
        <div>
          <h3 className="mb-2 text-sm font-semibold text-slate-700">Saved listings ({saved.rows.length})</h3>
